...
public class MyPart1Card extends Card {

	View v;
	TextView chrono;
	
	public MyPart1Card(String titlePlay, String description, String color,
	...
	public View getCardContent(Context context) {
		v = LayoutInflater.from(context).inflate(R.layout.card_part1, null);
	...
	public void onLoadView(){
		if (MainActivity.bPart1 == 0 && MainActivity.lPart1 != "justStarted"){
			chrono.setText(MainActivity.lPart1);
		}
		if (MainActivity.bPart1 == 1 && MainActivity.lPart1 == "justStarted"){
